...
readonly OS_GO_PACKAGE=github.com/openshift/cluster-openshift-controller-manager-operator
...
readonly OS_CROSS_COMPILE_TARGETS=(
  cmd/cluster-openshift-controller-manager-operator
)
...
function os::build::images() {
  ...
  os::build::image "${tag_prefix}-cluster-openshift-controller-manager-operator" .
}
