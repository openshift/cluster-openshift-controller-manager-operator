...
%global package_name origin-cluster-openshift-controller-manager-operator
%global product_name OpenShift Cluster openshift-controller-manager Operator
%global import_path github.com/openshift/cluster-openshift-controller-manager-operator
...
for bin in cluster-openshift-controller-manager-operator
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/cluster-openshift-controller-manager-operator
