...
func syncOpenShiftControllerManager_v311_00_to_latest(c OpenShiftControllerManagerOperator, originalOperatorConfig *v1.Config) (bool, error) {
	errors := []error{}
	var err error
	...
	if !equality.Semantic.DeepEqual(operatorConfig.Status, originalOperatorConfig.Status) {
		if _, err := c.operatorConfigClient.Configs().UpdateStatus(operatorConfig); err != nil {
			return false, err
		}
	}
...
func manageOpenShiftControllerManagerConfigMap_v311_00_to_latest(client coreclientv1.ConfigMapsGetter, recorder events.Recorder, operatorConfig *v1.Config) (*corev1.ConfigMap, bool, error) {
...
func manageOpenShiftControllerManagerDeployment_v311_00_to_latest(client appsclientv1.DaemonSetsGetter, recorder events.Recorder, options *v1.Config, imagePullSpec string, generationStatus []operatorv1.GenerationStatus, forceRollout bool) (*appsv1.DaemonSet, bool, error) {
