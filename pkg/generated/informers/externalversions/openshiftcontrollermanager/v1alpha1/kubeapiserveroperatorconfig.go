	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenshiftcontrollermanagerV1alpha1().KubeApiserverOperatorConfigs().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenshiftcontrollermanagerV1alpha1().KubeApiserverOperatorConfigs().Watch(options)
			},
		},
		&openshiftcontrollermanager_v1alpha1.KubeApiserverOperatorConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubeApiserverOperatorConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&openshiftcontrollermanager_v1alpha1.KubeApiserverOperatorConfig{}, f.defaultInformer)
}
