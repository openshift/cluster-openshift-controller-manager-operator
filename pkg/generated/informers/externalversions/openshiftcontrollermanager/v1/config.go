	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenshiftcontrollermanagerV1().Configs().List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenshiftcontrollermanagerV1().Configs().Watch(options)
			},
		},
		&openshiftcontrollermanager_v1.Config{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&openshiftcontrollermanager_v1.Config{}, f.defaultInformer)
}
