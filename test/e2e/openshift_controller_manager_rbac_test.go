...
func TestOpenshiftControllersRBAC(t *testing.T) {
	...
	expectedRBACs := []struct {
		...
		},
		{
			...
			expectedRolesYAML:        []string{"v3.11.0/openshift-controller-manager/serviceaccount-pull-secrets-controller-clusterrole.yaml"},
			expectedRoleBindingsYAML: []string{"v3.11.0/openshift-controller-manager/serviceaccount-pull-secrets-controller-clusterrolebinding.yaml"},
		},
		{
			name:                     "image-trigger-controller",
			expectedRolesYAML:        []string{"v3.11.0/openshift-controller-manager/image-trigger-controller-clusterrole.yaml"},
			expectedRoleBindingsYAML: []string{"v3.11.0/openshift-controller-manager/image-trigger-controller-clusterrolebinding.yaml"},
		},
		{
			name:                     "image-import-controller",
			expectedRolesYAML:        []string{"v3.11.0/openshift-controller-manager/image-import-controller-clusterrole.yaml"},
			expectedRoleBindingsYAML: []string{"v3.11.0/openshift-controller-manager/image-import-controller-clusterrolebinding.yaml"},
		},
		{
		...
		},
		{
			...
			expectedRolesYAML: []string{"v3.11.0/openshift-controller-manager/default-rolebindings-controller-clusterrole.yaml"},
			expectedRoleBindingsYAML: []string{
